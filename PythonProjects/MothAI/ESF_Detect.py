#!/Users/efortune/NotCloudy/MothBoxEnv/bin/python3
...
INPUT_PATH = r"/Users/efortune/NotCloudy/Mothbox-main/AI/SAMPLEYYDATA2025"  # raw string
...
# YOLO_MODEL = r"/Users/efortune/NotCloudy/Mothbox-main/AI/trained_models/train14_3000Images_batch2_1408px/weights/best.pt"
YOLO_MODEL = r"/Users/efortune/NotCloudy/Mothbox-main/AI/trained_models/yolo11m_4500_imgsz1600_b1_2024-01-18/weights/yolo11m_4500_imgsz1600_b1_2024-01-18.pt"
...
def scan_for_images(INPUT_PATH):
  """Scans subfolders for JPEG files and returns a list of file paths."""
  jpeg_files = []
  for filename in os.listdir(INPUT_PATH):
      if filename.endswith(".jpg"):
         jpeg_files.append(os.path.join(INPUT_PATH, filename))
  return jpeg_files
...
if __name__ == "__main__":
    ...
    images = scan_for_images(INPUT_PATH)
    process_jpg_files(images, INPUT_PATH)

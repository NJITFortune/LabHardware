...
def convert_to_time_int(exif_time):
    ...
    return int(time_diff.total_seconds() * 10)  # Convert to 100 ms resolution
...
def process_images(source_directory):
    ...
    with open(csv_filename, mode='w', newline='') as file:
        ...
        writer.writerow(["Filename", "Time (100ms resolution)"])
...
def plot_time_differences(image_times):
    ...
    plt.xlabel("Time (100ms resolution)")
    plt.ylabel("Time Difference (100ms)")
